          ...
          if (error.data?.detail) {
            ...
            Object.entries(error.data).forEach(([key, messages]) => {
              if (Array.isArray(messages)) {
                form.setError(key as keyof RegisterFormValues, { message: messages[0] });
              }
            });
          }
        } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">Start building with FileForge</p>
        </div>
        ...
        <Card>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              >
                {register.isPending || login.isPending ? "Creating account..." : "Sign up"}
              </Button>
